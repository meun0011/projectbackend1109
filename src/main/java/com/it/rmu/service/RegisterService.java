...
//    SendMailService mailService;
    ...
    public Integer save(RegisterRequestModel request) {
        ...
        if(null != request) {
            ...
            userEntity.setCreateBy("Cream");
            userEntity.setCreateDate(new Date());
            userEntity.setUpdateBy("Cream S");
            ...
            if(null != userEntity) {
                ...
                userDetailEntity.setCreateBy("Cream");
                userDetailEntity.setCreateDate(new Date());
                userDetailEntity.setUpdateBy("Cream S");
...
//        if(null != data) {
//            String emailTo = "fofordqaz@gmail.com";
    ...
    public Integer update(RegisterRequestModel request, Integer userId) {
        ...
        if(null != request) {
            ...
            if(userEntity.isPresent()) {
                ...
                user.setUpdateBy("update By Cream");
                ...
                if(null != userDetail) {
                    ...
                    userDetail.setUpdateBy("update By Cream");
